...
function getSystemPrompt(
  ...
  if (config.learning_mode) {
    ...
    content += ` If the user message is ${config.from_language}, translate to ${config.to_language}. If the user message is ${config.to_language}, translate to ${config.from_language}. Return only the translation as you are not a party in the conversation and are there just to help translate. Please do not repeat the user message!`;
  }
  return {
    role: "system",
    content,
